...
public class GoalieBenchmarkTeamResult extends TeamResult
{
	...
	public float getAverageDistance()
	{
		...
		for (ISingleResult result : results) {
			...
			if (result instanceof GoalieBenchmarkTeamResult) {
				avg += ((GoalieBenchmarkTeamResult) result).getAverageDistance();
			} else {
				avg += ((GoalieBenchmarkSingleResult) result).getDistance();
			}
		}
	...
	public float getLastDistance()
	{
		...
		if (result instanceof GoalieBenchmarkTeamResult) {
			return ((GoalieBenchmarkTeamResult) result).getLastDistance();
		} else {
			return ((GoalieBenchmarkSingleResult) result).getDistance();
		}
	}
}
