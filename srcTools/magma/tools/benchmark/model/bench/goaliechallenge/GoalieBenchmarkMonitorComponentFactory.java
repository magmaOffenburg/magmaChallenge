...
public class GoalieBenchmarkMonitorComponentFactory extends MonitorComponentFactory
{
	private final RunInformation runInfo;

	private final String roboVizServer;

	public GoalieBenchmarkMonitorComponentFactory(
	...
	public IReferee createReferee(IMonitorWorldModel worldModel, IServerCommander serverCommander)
	{
		...
		SinglePlayerLauncher launcher = new SinglePlayerLauncher(params.getServerIP(), params.getAgentPort(),
				params.getTeamPath(), params.getStartScriptName(), ChallengeType.GOALIE.startScriptArgument, false);
		return new GoalieBenchmarkReferee(worldModel, serverCommander, params.getServerPid(), launcher,
