...
public class Line2D
{
	...
	public double getDistanceTo(Vector2D thePoint)
	{
	 ...
	 * @return the intersection of this line with the passed line, null if none exists
	 */
	public Vector2D intersection(Line2D other)
	{
		// use commons math line class for this
		Line thisLine = new Line(start, getEnd(), 0.00001);
		Line otherLine = new Line(other.start, other.getEnd(), 0.00001);
		return thisLine.intersection(otherLine);
	}
