 ...
 * @author kdorer
 */
class ThrowInBenchmarkTableModelExtension extends DefaultTableModel
{
	...
	public static ThrowInBenchmarkTableModelExtension getInstance(List<TeamConfiguration> config)
	{
		final int COLUMNS = 8;
		...
		return new ThrowInBenchmarkTableModelExtension(content, headers);
	}

	private ThrowInBenchmarkTableModelExtension(Object[][] data, Object[] columnNames)
	{
