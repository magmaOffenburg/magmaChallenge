...
public class ThrowInBenchmarkMonitorComponentFactory extends MonitorComponentFactory
{
	private final RunInformation runInfo;

	private final String roboVizServer;

	public ThrowInBenchmarkMonitorComponentFactory(
	...
	public IReferee createReferee(IMonitorWorldModel worldModel, IServerCommander serverCommander)
	{
		...
		SinglePlayerLauncher launcher = new SinglePlayerLauncher(params.getServerIP(), params.getAgentPort(),
				params.getTeamPath(), params.getStartScriptName(), ChallengeType.THROW_IN.startScriptArgument, false);
		return new ThrowInBenchmarkReferee(worldModel, serverCommander, params.getServerPid(), launcher,
